...
| 3. Business / spec / functional architecture | 需要明确用户故事、验收标准、功能边界、模块依赖 | discovery, `CONTEXT.md`, ADRs, existing Spec | Spec, business architecture, functional architecture, Spec review notes | product design or contract design |
