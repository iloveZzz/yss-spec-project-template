...
```text
Language: 持久化文档正文默认使用中文输出；保留必要英文 metadata / identifier
```
...
Design Doc frontmatter 必须最小化，只包含英文 metadata；正文默认使用中文：
---
...
`openspec/changes/<name>/.comet/handoff/brainstorm-summary.md` 结构。除 Change 名称、日期和 Comet 状态值外，正文默认使用中文：
