...
try {
  ...
  if (registryPath === DEFAULT_REGISTRY) {
    ...
    const stalePaths = ["AGENTS.md", "README.md", ".template-spec/user-guide/用户手册.md", ".agents/skills/yss-product-lifecycle/SKILL.md", ".template-spec/process/lifecycle-artifact-map.md"];
