...
export function buildPlanFixture(root) {
  ...
  for (const ref of ['CONTEXT.md', '.template-spec/process/lifecycle-registry.yaml']) write(ref, readFileSync(path.join(ROOT, ref), 'utf8'));
