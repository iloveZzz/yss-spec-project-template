...
- `yss-microservice-components/yss-component-mail-starter` (existed when indexed)
...
- `yss-microservice-components/yss-component-mail-starter/src/main/java/com/yss/cloud/mail/MailParamsConstants.java`
- `yss-microservice-components/yss-component-mail-starter/src/main/java/com/yss/cloud/mail/SendMail.java`
- `yss-microservice-components/yss-component-mail-starter/src/main/java/com/yss/cloud/mail/SmtpEmailRequest.java`
