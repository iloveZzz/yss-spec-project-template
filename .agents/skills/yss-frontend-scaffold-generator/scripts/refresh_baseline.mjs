...
const theme = JSON.parse(readFileSync(path.join(repository, '.template-spec/design/tokens/theme.json')));
const css = readFileSync(path.join(repository, '.template-spec/design/tokens/variables.css'), 'utf8');
