...
description: Use when a GitLab Merge Request or code change needs review responsibilities, approval gates, SonarQube/SonarLint/Alibaba Java checks, or recorded reviewer feedback.
---
