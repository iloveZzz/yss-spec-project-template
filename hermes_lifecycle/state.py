...
def default_artifacts(pipeline: str) -> dict[str, str]:
    ...
    return {
        ...
        "plan": f".hermes/plans/{pipeline}.md",
...
def new_state() -> dict[str, Any]:
    return {"meta": {"version": "1.1", "template": "hermes-project-template"}, "pipelines": {}}
...
def _upgrade_state(state: dict[str, Any]) -> dict[str, Any]:
    ...
    upgraded["meta"].setdefault("template", "hermes-project-template")
