...
- 行为规格变化影响接口时，必须同步回写 `docs/api/specs/<feature>.yaml` 和 OpenSpec delta spec。
...
- [ ] OpenSpec / Comet change formalization 可引用本冻结记录。

## 6. 下一步门禁

- 结论：Approved / Blocked
- 下一步：OpenSpec / Comet change formalization
- 阻断项：
