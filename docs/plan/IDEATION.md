...
> **Plan 内部方法：生成可验证假设，再用 事实核查 事实校准。AI 是发散、挑战和组合机会的加速器。**
...
| 事实核查角色 | 事实验证角色，回答“证据支持什么、用户真实痛点是什么” | 市场、竞品、用户洞察、MVP 边界输入 |
...
如果只有一个模糊主题，可以先 Ideation 再 事实核查；如果已经有竞品、用户或行业材料，应先 事实核查 再 Ideation。二者循环到 Spec 前，必须收敛用户、痛点、做什么、不做什么和成功标准。
...
```
人类提主题或 事实核查 事实 → AI 发散候选机会 → 人类选择 Top 10
→ AI 挑战者分析 → 事实核查 验证证据 → AI 连接者找模式
