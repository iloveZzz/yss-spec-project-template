...
- [ ] 功能架构清楚：功能域、模块边界、优先级、依赖关系和 PRD 回填项已记录。
...
- [ ] 架构图如已生成，已引用明确上游文档，且图中发现的问题已回写到 PRD、OpenAPI、ADR、系统 / 数据架构设计 或 Issue。
...
- [ ] 架构决策已记录为 ADR
- [ ] 契约草案 / OpenAPI Draft 已经工程基线、系统/数据架构和 Issue 校验，并在开发前完成 OpenAPI Freeze
