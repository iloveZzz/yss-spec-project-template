...
| 协作层 | `triage`、`handoff` / 等价交接记录、Ticket tracker、Git checkpoint | 分诊、跨线程 / 跨仓库交接、同步状态、记录验证证据 |
...
| 落点 | 测试文件、Ticket/PR 评论、审查报告、必要时 ADR |
...
| 输入 | GitLab / GitHub Ticket、评论、标签、复现步骤、需求背景 |
...
| Skill | 用途 | 产物 |
|---|---|---|
| `setup-matt-pocock-skills` | 为仓库配置 Ticket tracker、triage label、领域文档布局 | `docs/agents/issue-tracker.md`、`docs/agents/triage-labels.md`、`docs/agents/domain.md`，并在 `AGENTS.md` 增加 Agent skills 区块 |
