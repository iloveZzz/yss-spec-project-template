...
| HOB-004 | 已落地 | 明确集中 Git checkpoint 与 Ticket 同步最小模板 | 连续推进若逐阶段重复落记录成本高，集中记录又可能丢失因果关系。 | `docs/process/templates/stage-checkpoint-template.md` | 在人工暂停、handoff、进入实现、合并或发布边界按固定字段记录本轮覆盖阶段、产物、验证、阻塞、人工审查、排除的脏文件和下一步。 |
