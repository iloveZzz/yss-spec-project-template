...
| 系统 / 数据架构与工程契约 | 固化系统、数据、工程基线和 API 契约 | 架构审查、工程基线、OpenAPI Draft / Freeze、ADR | 受影响的工程契约冻结或记录无 API 影响 |
...
| Slice Implementation Contract | Agent 进入实现 | 批准的 Slice Implementation Contract |
