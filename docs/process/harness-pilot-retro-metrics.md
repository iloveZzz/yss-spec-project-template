...
| 规范偏离次数 | 违反流程、模板、YSS、OpenSpec / Comet 或安全红线的次数 | Review、Architecture Re-check、Issue | 降低 |
...
| 人审阻断命中次数 | 安全红线或不可逆变更触发人工审查的次数 | `TODO-HUMAN-REVIEW`、Review 记录 | 可解释，不追求为零 |
