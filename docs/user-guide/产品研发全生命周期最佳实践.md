...
| 高保真 HTML 原型 | `product-design:index` 路由到 Product Design focused skill；`antd` CLI | 低保真评审通过后的强制产物；必须使用 Ant Design v6，输出 `docs/.scratch/<feature>/design/prototypes/index.html`，记录 AntD CLI 校验证据并获得用户确认 |
