...
| `gate.strategic-design-handoff-approved` | 战略设计交付批准 | `stage.ticket-formalization` | 业务上游 Harness profile 完成 Spec、页面原型和业务级 Ticket，需要交付下游 Tactical DDD。 | `gate.stage-decision-package-approved`、`gate.spec-baseline-approved`、`gate.user-confirmation` | `evidence.strategic-design-handoff`、`evidence.approval-record` |
...
| `artifact.strategic-design-handoff` | Strategic Design Handoff | `stage.ticket-formalization` | 业务上游 Harness 完成战略设计、Spec、页面原型和业务级 Ticket，需要交付下游研发团队进行 Tactical DDD。 |
...
| `evidence.strategic-design-handoff` | 战略设计交付包验证证据 | Strategic Design Handoff 的来源 digest、业务级 Ticket、下游 Tactical DDD 问题和交付完整性验证结果。 |
