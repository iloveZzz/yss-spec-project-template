...
for(const name of ['readFileSync','readdirSync','lstatSync','statSync','existsSync','realpathSync','cpSync','copyFileSync','mkdirSync','writeFileSync','fsyncSync','openSync','closeSync','fchmodSync','renameSync']) {
